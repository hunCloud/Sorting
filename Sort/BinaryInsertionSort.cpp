...
void binaryInsertionSort(int a[], int n)
{
	...
	for (i = 1; i < n; i++)// examine from first element to n-1
	{
		key = a[i];
		// a[0] = key;
		l = 0;
...
int main(int argc, char const *argv[])
{
	...
	binaryInsertionSort(a, SIZE_OF_ARRAY);
...
// The idea is find the position in the left subarray that is sorted will
// use binary search.
/*
