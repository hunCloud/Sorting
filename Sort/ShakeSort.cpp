...
{
	int l, r, j, k;// create l, r to determine left adn right to examine
	// declare index j, k is to store  the position the index that complete
	l = 1; // start with index 1
	r = n - 1;
	do
	{
		for (j = r; j >= l; j--)
